...
- *Devices* shows the number of devices connected to this Mesh router, via Ethernet cable or 2.4G WiFi or 5G WiFi. Click [*More Details*](status.md#device){ data-preview } to know more information about these devices or configure the settings.
...
- [DHCP Server](dhcp.md#){ data-preview }: Specify the IP address for client devices by the Mesh router as a DHCP Server.
