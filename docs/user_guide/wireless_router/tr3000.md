...
## Overview
- Check the [package content](overview_tr3000.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_tr3000.md#front-panel){ data-preview } and [back](overview_tr3000.md#back-panel){ data-preview }.
- View the [interfaces](overview_tr3000.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_tr3000.md#front-panel){ data-preview } status and indication.
...
- [USB Tethering](usb.md#tethering-settings){ data-preview }: Allow the router to access the Internet through a mobile device connected via USB.
...
- [Captive Portal](captive_portal.md){ data-preview }: Allow you to design a portal page for network access verification. Customers are directed to view an advertisement or accept set terms before being granted Internet access. In this way, it offers unique marketing opportunities for small businesses to improve brand awareness and deliver marketing messages. 
