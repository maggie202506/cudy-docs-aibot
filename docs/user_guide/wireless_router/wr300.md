...
## Overview
- Check the [package content](overview_wr300.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr300.md#front-panel){ data-preview } and [back](overview_wr300.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr300.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr300.md#front-panel){ data-preview } status and indication.
