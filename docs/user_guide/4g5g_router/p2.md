...
## Overview
- Check the [package content](overview_p2.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_p2.md#front-panel){ data-preview } and [back](overview_p2.md#back-panel){ data-preview }.
- View the [interfaces](overview_p2.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_p2.md#front-panel){ data-preview } status and indication.
