...
**Wireless 5G** is to customize the Router’s 5GHz wireless settings, including SSID and password, mode, channel, channel width and transmit power, and so on. 

Go to **General Settings >> Wireless 5G** and follow the steps below to configure it.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/wireless_router/wireless_5g.webp" alt="" width="800px" style="border: 1px solid #eee;" />
